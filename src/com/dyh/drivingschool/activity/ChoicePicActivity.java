...
//					Toast.makeText(getApplicationContext(), "���ڱ���", Toast.LENGTH_SHORT).show();
					new Thread(){
						@Override
						public void run() {
...
//					getRotatedBitmap(180,filePath);
					FileToServer.reg(ChoicePicActivity.this, path, new File(filePath),id);
				}
				//向首界面发送图片
//				Bundle bundle=new Bundle();
//				bundle.putString(Tag, path);
//				IntentUtil.activityForward(ChoicePicActivity.this, TestActivty.class, bundle,true );
//				FileToServer.reg(ChoicePicActivity.this, new File(filePath), NetUrl.TEST_HOST+InterfaceParams.App_Pic_Upload,id);
				setResult(code, data );
//				finish();
			}
